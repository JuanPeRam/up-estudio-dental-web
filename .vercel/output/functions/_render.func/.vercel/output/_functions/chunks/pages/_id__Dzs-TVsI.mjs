/* empty css                           */
import { e as createAstro, f as createComponent, r as renderTemplate, j as renderComponent, m as maybeRenderHead, h as addAttribute, i as renderTransition } from '../astro_DXoMm21L.mjs';
import 'kleur/colors';
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": "", "title": memberData?.name ?? "", "data-astro-cid-x3vkudht": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="w-full min-h-screen row-center flex-col" data-astro-cid-x3vkudht> <article class="w-[50vw] column-center backdrop-blur-md rounded-md border max-w-[550px] min-w-[400px]" data-astro-cid-x3vkudht> <h2 class="text-xl font-bold w-fit text-center p-5" data-astro-cid-x3vkudht>${memberData?.name}</h2> <div class="w-[350px] h-[350px] p-5" data-astro-cid-x3vkudht> <img${addAttribute(`../${memberData?.picture}`, "src")}${addAttribute(memberData?.name, "alt")} class="object-cover w-full h-full shadow-md object-center rounded-full" data-astro-cid-x3vkudht${addAttribute(renderTransition($$result2, "r3usurhe", "", `${memberData?.id}-image`), "data-astro-transition-scope")}> </div> <article class="border-t p-5 backdrop-blur-md w-fit" data-astro-cid-x3vkudht> <div class="text-pretty w-fit" data-astro-cid-x3vkudht>${memberData?.description}</div> </article> </article> </section> ` })} `;
}, "C:/Users/Pere/Documents/GitHub/up-estudio-dental-web/src/pages/member/[id].astro", "self");

const $$file = "C:/Users/Pere/Documents/GitHub/up-estudio-dental-web/src/pages/member/[id].astro";
const $$url = "/member/[id]";
